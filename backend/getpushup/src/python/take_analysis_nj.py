...
def detect_and_display(video_path, analysisId): # landmark 추출
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))  # 현재 위치: getpushup/src/pushup/python
    output_dir = os.path.abspath(os.path.join(script_dir, '..', '..', '..', 'output_video'))  # 루트 기준
